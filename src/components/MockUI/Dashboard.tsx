    ...
    <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 space-y-4">
      ...
      <div>
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm font-semibold text-slate-900 tabular-nums">{current.spend}%</span>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-slate-50 rounded-xl p-4">
          ...
          <p className="text-xl font-bold text-slate-900 tabular-nums transition-all duration-500">{current.cpa}</p>
        ...
        <div className="bg-slate-50 rounded-xl p-4">
          ...
          <p className="text-xl font-bold text-slate-900 tabular-nums transition-all duration-500">{current.roas}</p>
          <div className="flex items-center gap-1 text-emerald-600 text-xs mt-1">
        ...
        <div className="bg-slate-50 rounded-xl p-4">
          ...
          <p className="text-xl font-bold text-slate-900 tabular-nums transition-all duration-500">{current.cv}</p>
          <div className="flex items-center gap-1 text-emerald-600 text-xs mt-1">
            <TrendingUp className="w-3 h-3" />
      ...
      <div className="flex items-center justify-between pt-4 border-t border-slate-100">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            />
            <span className={`w-2 h-2 rounded-full transition-all duration-300 ${activeChannel === "meta" ? "bg-emerald-500 shadow-[0_0_0_4px_rgba(16,185,129,0.18)]" : "bg-slate-300"}`}></span>
          ...
          <div className="flex items-center gap-2">
            <Image
              ...
              className="w-3.5 h-3.5"
            />
            <span className={`w-2 h-2 rounded-full transition-all duration-300 ${activeChannel === "google" ? "bg-emerald-500 shadow-[0_0_0_4px_rgba(16,185,129,0.18)]" : "bg-slate-300"}`}></span>
            <span className="text-xs text-slate-600">Google広告</span>
          </div>
        </div>
        <span className="text-xs text-slate-400">最終更新: {current.updatedAt}</span>
      </div>
    </div>
  );
}
