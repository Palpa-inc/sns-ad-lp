    ...
    <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          <span className="inline-flex items-center gap-1.5 bg-slate-100 text-slate-600 px-2.5 py-1 rounded-md text-xs">
          ...
          <span className="inline-flex items-center gap-1.5 bg-slate-100 text-slate-600 px-2.5 py-1 rounded-md text-xs">
            <TriangleAlert className="w-3.5 h-3.5 text-sky-600" />
            異常アラート
          </span>
        </div>
        ...
        {/* AI Response */}
        <div
          className={`${displayedScenario.responseClass} rounded-xl p-4 border min-h-[214px] transition-all duration-300 ease-out ${
            showResponseShell
              ...
              <div className="relative min-h-[158px] mt-3">
                ...
                >
                  <div className="w-full">
                    <p className="text-sm text-slate-600 mb-3 inline-flex items-center gap-2">
                      最適化プランを作成中...
